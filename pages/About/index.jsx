        ...
        <>
            ...
            <div class="aboutGrid">
                <div class="aboutText">
                    ...
                    <br />
                    <p>I spent a lot of my days in my young adult life in the punk scene, and I wanted this business to evoke those days as well as stand
                        out from the other buisnesses in the area. So we've rebanded to the Bad Ass Baking Company!</p>
                    <br />
                    <p>To the regulars of the West End Bakery, we're still here! We might look a little edgy, but we're still serving the same baked goods
                        and catering services we've always had, with some great new products we think you'll love just as much!</p>
                </div>
                <div class="aboutImage">
                    <img src="../src/assets/img/BaB_StorefrontMockup.jpg" alt="" />
                </div>
            </div>
